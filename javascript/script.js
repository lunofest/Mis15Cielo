...
function updateTimer() {
  const targetDate = new Date("february 15, 2025 21:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '542257603852'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '542257603852'; // Número para el primer botón
